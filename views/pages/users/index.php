<div class="p-4 md:p-6 space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">ພະນັກງານ</h1>
            <p class="text-sm text-gray-500">ຈັດການຜູ້ໃຊ້ງານລະບົບ</p>
        </div>
        <a href="<?= url('/users/create') ?>" class="bg-primary text-white rounded-xl px-4 py-2 font-bold hover:opacity-90 inline-flex items-center gap-2">

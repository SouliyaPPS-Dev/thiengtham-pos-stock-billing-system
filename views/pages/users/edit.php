    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-muted-foreground mt-0.5">ແກ້ໄຂຂໍ້ມູນ: <?= htmlspecialchars($user['fullname'] ?? $user['username']) ?></p>
            </div>
        </div>
                ...
                <div class="bg-card rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p class="text-xs text-muted-foreground mt-1">ປະໄວ້ວ່າງ ຖ້າບໍ່ຕ້ອງການປ່ຽນລະຫັດ</p>
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-sm font-bold text-foreground/85 flex items-center gap-1.5">

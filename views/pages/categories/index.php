                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-6 md:p-8">
                    ...
                    <form action="<?= url('/categories/store') ?>" method="POST" class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="name" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all bg-white text-sm placeholder:text-gray-300" placeholder="ຊື່ໝວດສິນຄ້າ">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-sm font-bold text-gray-700 flex items-center gap-1.5">
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all bg-white text-sm placeholder:text-gray-300 resize-none" placeholder="ລາຍລະອຽດໝວດສິນຄ້າ"></textarea>
                        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 w-full max-w-md" onclick="event.stopPropagation()">
        ...
        <form id="editForm" method="POST" class="space-y-4">
            <div class="space-y-1.5">
                ...
                <input type="text" name="name" id="editName" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all bg-white text-sm">
            </div>
            <div class="space-y-1.5">
                <label class="text-sm font-bold text-gray-700 flex items-center gap-1.5">
                    <i class="fas fa-align-left text-[10px] text-violet-500"></i>
                ...
                <textarea name="description" id="editDescription" rows="3" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all bg-white text-sm resize-none"></textarea>
            </div>

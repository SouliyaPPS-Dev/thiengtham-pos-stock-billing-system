    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-muted-foreground mt-0.5">ແກ້ໄຂຂໍ້ມູນ: <?= htmlspecialchars($product['name']) ?></p>
            </div>
        </div>
                    ...
                    <div class="space-y-5">
                        <div class="space-y-1.5">
                            ...
                            <textarea name="description" rows="4"
                                      class="w-full px-4 py-3 border border-border rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all bg-card text-sm placeholder:text-gray-300 resize-none"><?= htmlspecialchars($product['description'] ?? '') ?></textarea>
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-sm font-bold text-foreground/85 flex items-center gap-1.5">
                                ...
                                <div class="relative rounded-2xl overflow-hidden border border-border group"
                                    ...
                                    <div class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/50 to-transparent p-4 flex items-center justify-between">
                                        ...
                                        <button type="button" @click="$refs.fileInput.click()"
                                                class="px-3 py-1.5 bg-card/90 backdrop-blur rounded-xl text-xs font-bold text-foreground/85 hover:bg-card transition-all">
                                            ປ່ຽນຮູບ
                                        </button>
                                    </div>
                                </div>

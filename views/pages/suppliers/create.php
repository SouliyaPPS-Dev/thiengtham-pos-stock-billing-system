    ...
    <div class="table-wrap">
        <form action="<?= url('/suppliers/store') ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1.5">
                ...
                <input type="text" name="name" required class="form-input" placeholder="ປ້ອນຊື່ຜູ້ສະໜອງ">
            </div>
            <div class="space-y-1.5">
                <label class="form-label">ຜູ້ຕິດຕໍ່</label>
                <input type="text" name="contact_person" class="form-input" placeholder="ຊື່ຜູ້ຕິດຕໍ່">
            </div>
            <div class="space-y-1.5">

    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-muted-foreground mt-0.5">ແກ້ໄຂຂໍ້ມູນ: <?= htmlspecialchars($supplier['name']) ?></p>
            </div>
        </div>

        <!-- Form -->
        <form action="<?= url('/suppliers/' . $supplier['id'] . '/update') ?>" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="notes" rows="3"
                                  ...
                                  placeholder="ໝາຍເຫດ"><?= htmlspecialchars($supplier['notes'] ?? '') ?></textarea>
                    </div>
                </div>

    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-6 md:p-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pb-4 border-b border-gray-100 mb-4">
                ...
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1"><?= !empty($sale['supplier_name']) ? 'ຜູ້ສະໜອງ' : 'ລູກຄ້າ' ?></p>
                    <p class="font-bold text-gray-800"><?= !empty($sale['supplier_name']) ? htmlspecialchars($sale['supplier_name']) : htmlspecialchars($sale['customer_name'] ?? 'ລູກຄ້າທົ່ວໄປ') ?></p>
                </div>
                <div>

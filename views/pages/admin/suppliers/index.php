        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
            <form method="GET" action="<?= url('/admin/suppliers') ?>" class="flex flex-col sm:flex-row gap-3 mb-6">
                <div class="flex-1 relative group">
                    ...
                    <input type="text" name="search" value="<?= htmlspecialchars($_GET['search'] ?? '') ?>" placeholder="ຄົ້ນຫາຊື່, ເບີໂທ, ຜູ້ຕິດຕໍ່..." class="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none text-sm">
                </div>

    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">ສ້າງຂໍ້ມູນສິນຄ້າໃໝ່ໃນລະບົບ</p>
            </div>
        </div>

        <form action="<?= url('/admin/products/store') ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-sm font-bold text-gray-700">ສະຕ໋ອກເລີ່ມຕົ້ນ</label>
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <span class="ml-3 text-sm text-gray-600 peer-checked:text-green-600" id="statusLabel">ເປີດໃຊ້ງານ</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100">
                <div class="space-y-1.5 mb-6">
                    ...
                    <textarea name="description" rows="3" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none text-sm resize-none" placeholder="ລາຍລະອຽດສິນຄ້າ"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                </div>

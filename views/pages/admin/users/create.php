    ...
    <div class="max-w-2xl mx-auto space-y-6 animate-fade-in">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">ສ້າງຜູ້ໃຊ້ງານໃໝ່</p>
            </div>
        </div>

        <form action="<?= url('/admin/users/store') ?>" method="POST" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-1.5">
                    <label class="text-sm font-bold text-gray-700">ລະຫັດຜ່ານ <span class="text-red-400">*</span></label>

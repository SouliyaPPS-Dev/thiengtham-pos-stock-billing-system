...
return [
    ...
    '/admin/products/bulk-delete'       => ['Admin\ProductController', 'bulkDelete'],
    ...
    '/admin/categories/bulk-delete'       => ['Admin\CategoryController', 'bulkDelete'],
    ...
    '/admin/customers/bulk-delete' => ['Admin\CustomerController', 'bulkDelete'],
    ...
    '/admin/bid-customers/bulk-delete'       => ['Admin\BidCustomerController', 'bulkDelete'],
    ...
    '/admin/promotions/bulk-delete'  => ['Admin\PromotionController', 'bulkDelete'],
    ...
    '/admin/expenses/bulk-delete'   => ['Admin\ExpenseController', 'bulkDelete'],
    ...
    '/admin/users/bulk-delete' => ['Admin\UserController', 'bulkDelete'],
    ...
    '/admin/quotations/bulk-delete'       => ['Admin\QuotationController', 'bulkDelete'],

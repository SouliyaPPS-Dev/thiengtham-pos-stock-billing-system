<div class="p-4 md:p-8" x-data="staffModal()">
    ...
    <div x-show="showModal" x-cloak @keydown.window.enter="if(showModal) saveStaff()" class="fixed inset-0 z-[9999] bg-black/50 flex items-center justify-center p-4 overflow-y-auto">
